...
var Formsy = function (_React$Component) {
  ...
  function Formsy(props) {
    ...
    _this.runValidation = function (component) {
      ...
      var existingValues = arguments[2];

      var currentValues = existingValues || _this.getCurrentValues();
    ...
    _this.attachToForm = function (component) {
      if (_this.inputs.indexOf(component) === -1) {
        ...
        _this.pristineValues[component.props.name] = component.props.value;
        // set initial value for the component
        component.state.value = _utils2.default.byString(_this.props.initialValues, component.props.name) || component.state.defalutValue;
      }
    ...
    _this.detachFromForm = function (component) {
      ...
      if (componentPos !== -1) {
        delete _this.pristineValues[component.props.name];
    ...
    _this.isChanged = function () {
      return !_utils2.default.isSame(_this.pristineValues, _this.getCurrentValues());
    };
    ...
    _this.validateForm = function () {
      ...
      _this.inputs.forEach(function (component, index) {
        var validation = _this.runValidation(component, component.state.value, currentValues);
