  ...
  function Formsy(props) {
    ...
    _this.attachToForm = function (component) {
      if (_this.inputs.indexOf(component) === -1) {
        ...
        var initialValue = _utils2.default.byString(_this.props.initialValues, component.props.name) || component.state.defalutValue;
        _this.pristineValues[component.props.name] = initialValue;
